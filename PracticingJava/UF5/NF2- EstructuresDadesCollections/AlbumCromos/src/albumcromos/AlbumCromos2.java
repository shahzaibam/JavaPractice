...
public class AlbumCromos2 {
    ...
    public static void main(String[] args) {
        AlbumCromos2 app = new AlbumCromos2();
        app.run();
    ...
    private void listadoAlbum(CromoDAO_Hash album) {
        ...
        Map<Integer,String> nuevos_album = album.getAlbum2();
        
        Set<Integer> keys = nuevos_album.keySet();
        
        for (Integer clave : keys) {
            String descripcio = nuevos_album.get(clave);
            System.out.println("foreach[" + clave + "]=>"+descripcio+"");
        }
